...
function customerToForm(customer: Customer): EditCustomerRequest {
  return {
    first_name: customer.first_name || "",
    last_name: customer.last_name || "",
    email: customer.email || "",
    phone_number: customer.phone_number || "",
    residence_city_id: customer.residence_city_id.toString(),
    address: customer.address || "",
  };
}

export interface EditCustomerFormProps {
  onSubmit: (values: EditCustomerRequest) => void;
  customerId: number;
}
...
export function EditCustomerForm({
  ...
  if (cities.status !== "success" || customer.status !== "success") return null;
  const initialValues = customerToForm(customer.data);
  return (
    <Formik
